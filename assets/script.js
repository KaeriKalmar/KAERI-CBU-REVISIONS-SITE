...
let allEssayData = [];
let allFlashcards = {};
let allDocuments = []; // Added support for documents if defined
...
const fullAccessCodes = {
  // === BI110 ===
  "BI110_T1": [
    "BI110T1_MAIN001#A@", "BI110T1_MAIN002!Z*", "BI110T1_MAIN003$K#", "BI110T1_MAIN004&Y!",
    "BI110T1_MAIN005*X%", "BI110T1_MAIN006^R&", "BI110T1_MAIN007~S+", "BI110T1_MAIN008?D#",
    "BI110T1_MAIN009|Q$", "BI110T1_MAIN010<>P", "BI110T1_BONUS011 %1", "BI110T1_BONUS012 @2",
    "BI110T1_BONUS013 #3", "BI110T1_BONUS014 &4", "BI110T1_BONUS015 *5", "BI110T1_BONUS016 ^6",
    "BI110T1_EXTRA017 ~7", "BI110T1_EXTRA018 ?8", "BI110T1_TEST019 |9", "BI110T1_TEST020 <0"
  ],
  "BI110_T2": [
    "test111", "BI110T2_MAIN001#A@", "BI110T2_MAIN002!Z*", "BI110T2_MAIN003$K#", "BI110T2_MAIN004&Y!",
    "BI110T2_MAIN005*X%", "BI110T2_MAIN006^R&", "BI110T2_MAIN007~S+", "BI110T2_MAIN008?D#",
    "BI110T2_MAIN009|Q$", "BI110T2_MAIN010<>P", "BI110T2_BONUS011 %1", "BI110T2_BONUS012 @2",
    "BI110T2_BONUS013 #3", "BI110T2_BONUS014 &4", "BI110T2_BONUS015 *5", "BI110T2_BONUS016 ^6",
    "BI110T2_EXTRA017 ~7", "BI110T2_EXTRA018 ?8", "BI110T2_TEST019 |9", "BI110T2_TEST020 <0",
    "BI&CS110T2@"
  ],
  "BI110_T3": [
    "BI110T3_MAIN001#A@", "BI110T3_MAIN002!Z*", "BI110T3_MAIN003$K#", "BI110T3_MAIN004&Y!",
    "BI110T3_MAIN005*X%", "BI110T3_MAIN006^R&", "BI110T3_MAIN007~S+", "BI110T3_MAIN008?D#",
    "BI110T3_MAIN009|Q$", "BI110T3_MAIN010<>P", "BI110T3_BONUS011 %1", "BI110T3_BONUS012 @2",
    "BI110T3_BONUS013 #3", "BI110T3_BONUS014 &4", "BI110T3_BONUS015 *5", "BI110T3_BONUS016 ^6",
    "BI110T3_EXTRA017 ~7", "BI110T3_EXTRA018 ?8", "BI110T3_TEST019 |9", "BI110T3_TEST020 <0", "ElijA⚓H"
  ],
  // === CS110 ===
  "CS110_T1": [
    "CS110T1_MAIN001#A@", "CS110T1_MAIN002!Z*", "CS110T1_MAIN003$K#", "CS110T1_MAIN004&Y!",
    "CS110T1_MAIN005*X%", "CS110T1_MAIN006^R&", "CS110T1_MAIN007~S+", "CS110T1_MAIN008?D#",
    "CS110T1_MAIN009|Q$", "CS110T1_MAIN010<>P", "CS110T1_BONUS011 %1", "CS110T1_BONUS012 @2",
    "CS110T1_BONUS013 #3", "CS110T1_BONUS014 &4", "CS110T1_BONUS015 *5", "CS110T1_BONUS016 ^6",
    "CS110T1_EXTRA017 ~7", "CS110T1_EXTRA018 ?8", "CS110T1_TEST019 |9", "CS110T1_TEST020 <0"
  ],
  "CS110_T2": [
    "CS110T2_MAIN002!Z*", "CS110T2_MAIN004&Y!", "CS110T2_MAIN005*X%", "CS110T2_MAIN006^R&",
    "CS110T2_MAIN007~S+", "CS110T2_MAIN008?D#", "CS110T2_MAIN009|Q$", "CS110T2_MAIN010<>P",
    "CS110T2_BONUS011 %1", "CS110T2_BONUS012 @2", "CS110T2_BONUS013 #3", "CS110T2_BONUS014 &4",
    "CS110T2_BONUS015 *5", "CS110T2_BONUS016 ^6", "CS110T2_EXTRA017 ~7", "CS110T2_EXTRA018 ?8",
    "CS110T2_TEST019 |9", "CS110T2_TEST020 <0", "BI&CS110T2@",
    "CS110T2_CORE041!A#", "CS110T2_CORE042#B$", "CS110T2_CORE043%X", "CS110T2_CORE044^Y*",
    "CS110T2_CORE045*Z@", "CS110T2_CORE046~M%", "CS110T2_CORE047?N^", "CS110T2_CORE048|P~",
    "CS110T2_CORE049<QR", "CS110T2_CORE050>ST", "CS110T2_BONUS051 +1", "CS110T2_BONUS052 -2",
    "CS110T2_BONUS053 =3", "CS110T2_BONUS054 _4", "CS110T2_BONUS055 :5", "CS110T2_BONUS056 ;6",
    "CS110T2_EXTRA057 [7", "CS110T2_EXTRA058 ]8", "CS110T2_TEST059 {9", "CS110T2_TEST060 }0",
    "CS110T2_MAIN003$K#"
  ],
  "CS110_T3": [
    "CS110T3_MAIN001#A@", "CS110T3_MAIN002!Z*", "CS110T3_MAIN003$K#", "CS110T3_MAIN004&Y!",
    "CS110T3_MAIN005*X%", "CS110T3_MAIN006^R&", "CS110T3_MAIN007~S+", "CS110T3_MAIN008?D#",
    "CS110T3_MAIN009|Q$", "CS110T3_MAIN010<>P", "CS110T3_BONUS011 %1", "CS110T3_BONUS012 @2",
    "CS110T3_BONUS013 #3", "CS110T3_BONUS014 &4", "CS110T3_BONUS015 *5", "CS110T3_BONUS016 ^6",
    "CS110T3_EXTRA017 ~7", "CS110T3_EXTRA018 ?8", "CS110T3_TEST019 |9", "CS110T3_TEST020 <0",
    "CS110T1_MAIN001#A@", "CS110T1_MAIN002!Z*", "CS110T1_MAIN003$K#", "CS110T1_MAIN004&Y!",
    "CS110T1_MAIN005*X%", "CS110T1_MAIN006^R&", "CS110T1_MAIN007~S+", "CS110T1_MAIN008?D#",
    "CS110T1_MAIN009|Q$", "CS110T1_MAIN010<>P", "CS110T1_BONUS011 %1", "CS110T1_BONUS012 @2",
    "CS110T1_BONUS013 #3", "CS110T1_BONUS014 &4", "CS110T1_BONUS015 *5", "CS110T1_BONUS016 ^6",
  ...
  "GLOBAL_ALL_TERMS": [
    "kk22kk4", "Lizzy", "SUPER_USER_XYZ_789", "All-terms@#<0", "Lizzy@", "becky @&_", "KULIKA🌟",
    "FULL_UNLOCK_2025", "ACCESS_GRANTED_GLOBAL$", "CBU_UNLOCK_CODE🔥", "MASTER_KEY_∞_ENTRY",
    "EVERYTHING_PASS_T1T2T3", "ULTRA_PASS_9999", "ONE_KEY_TO_RULE_THEM_ALL", "GLOBAL_MASTER_777🔐",
    "UNIVERSAL_ACCESS_VIP", "CBU_ELITE_KEY2025", "TOTAL_DOMINATOR_CODE", "UNLOCK_THIS_WORLD",
    "OPEN_ALL_LEVELS_📘", "ROOT_ACCESS_GRANTED!", "KAERI_GLOBAL_TERMS🔓", "REAL🌟JED", "All-terms@#<00"
  ],
  "CS110_ALL_TERMS": [
    "CS110_PRO_PASS_ABC", "CS110_GOLD_MEMBER", "CS110_TERM_UNLOCKER_1", "CS110_T1_T2_T3_UNLOCK",
    "CS110_PREMIUM_2025!", "CS110_TOTAL_ACCESS+", "CS110_FULL_KIT_KEY", "CS110_ALL_YEARS_PASS",
    "CS110_GENIUS_MODE_🔓", "CS110_MERIT_GRANT2025", "CS110_TOP_SECRET_PASS", "CS110_ULTIMATE_KEY#",
    "CS110_QUANTUM_ENTRY", "CS110_ALL_TERM_ENTRY", "CS110_BRAINY_MODE_007", "CS110_UNLOCKZILLA🔥",
    "CS110_PASSCARD_24/7", "CS110_ELITE_ACADEMY", "CS110_MASTERCLASS_✓", "CS110_PRO_PLUS_TERMS"
  ],
  "BI110_ALL_TERMS": [
    "BI110_BUNDLE_PACK_123", "BI110_TOTAL_ACCESS", "BI110_PRO_MODE", "BI110_FULL_SEMESTER_KEY",
    "BI110_TEST_PASS_XYZ", "BI110_T1_T2_T3_OKAY", "BI110_GRADEBOOST_2025", "BI110_FLASHCARDS_OPENALL",
    "BI110_MASTER_UNLOCK", "BI110_STAR_USER_KEY", "BI110_REVISION_KING", "BI110_TOP_MARKS_KEY",
    "BI110_ACCESS_ALL🌱", "BI110_FULL_POWER_CODE", "BI110_PASS_ANYTIME", "BI110_KNOWLEDGE_HUB🔓",
    "BI110_ALL_TERM_ENTRY", "BI110_SMART_PASS@2025", "BI110_UNLOCK_MY_BRAIN", "BI110_KAERI_SPECIAL_KEY"
  ]
};
...
const alreadyActivatedCodes = [
  "MASTER_ACCESS_2025!@#$", "CS110T2_BONUS014 &4", "BI110T1_MAIN001#A@", "BI110T1_MAIN002!Z*",
  "BI110T1_MAIN003$K#", "BI110T1_MAIN004&Y!", "BI110T1_MAIN005*X%", "BI110T1_MAIN006^R&",
  "BI110T1_MAIN007~S+", "BI110T1_MAIN008?D#", "BI110T1_MAIN009|Q$", "BI110T1_MAIN010<>P",
  "BI110T1_BONUS011 %1", "BI110T1_BONUS012 @2", "BI110T1_BONUS013 #3", "BI110T1_BONUS014 &4",
  "BI110T1_BONUS015 *5", "BI110T1_BONUS016 ^6", "BI110T1_EXTRA017 ~7", "BI110T1_EXTRA018 ?8",
  "BI110T1_TEST019 |9", "BI110T1_TEST020 <0", "test111", "BI110T2_MAIN001#A@", "BI110T2_MAIN002!Z*",
  "BI110T2_MAIN004&Y!", "BI110T2_MAIN006^R&", "BI110T2_MAIN007~S+", "BI110T2_MAIN008?D#",
  "BI110T2_MAIN009|Q$", "BI110T2_MAIN010<>P", "BI110T2_BONUS011 %1", "BI110T2_BONUS012 @2",
  "BI110T2_BONUS013 #3", "BI110T2_BONUS014 &4", "BI110T2_BONUS015 *5", "BI110T2_BONUS016 ^6",
  "BI110T2_EXTRA017 ~7", "BI110T2_EXTRA018 ?8", "BI110T2_TEST019 |9", "BI110T2_TEST020 <0",
  "BI110T3_MAIN001#A@", "BI110T3_MAIN002!Z*", "BI110T3_MAIN003$K#", "BI110T3_MAIN004&Y!",
  ...
  "BI110T3_MAIN009|Q$", "BI110T3_MAIN010<>P", "BI110T3_BONUS011 %1", "BI110T3_BONUS012 @2",
  "BI110T3_BONUS013 #3", "BI110T3_BONUS014 &4", "BI110T3_BONUS015 *5", "BI110T3_BONUS016 ^6",
  "BI110T3_EXTRA017 ~7", "BI110T3_EXTRA018 ?8", "BI110T3_TEST019 |9", "BI110T3_TEST020 <0",
  "CS110T2_MAIN003$K#", "CS110T2_MAIN004&Y!", "CS110T2_MAIN005*X%", "CS110T2_MAIN006^R&",
  "CS110T2_MAIN007~S+", "CS110T2_MAIN008?D#", "CS110T2_MAIN009|Q$", "CS110T2_MAIN010<>P",
  "CS110T2_BONUS011 %1", "CS110T2_BONUS012 @2", "CS110T2_BONUS013 #3", "CS110T2_BONUS014 &4",
  "CS110T2_BONUS015 *5", "CS110T2_BONUS016 ^6", "CS110T2_EXTRA017 ~7", "CS110T2_EXTRA018 ?8",
  "CS110T2_TEST019 |9", "CS110T2_TEST020 <0", "CS110T2_CORE041!A#", "CS110T2_CORE042#B$",
  "CS110T2_CORE043%X", "CS110T2_CORE044^Y*", "CS110T2_CORE045*Z@", "CS110T2_CORE046~M%",
  "CS110T2_CORE047?N^", "CS110T2_CORE048|P~", "CS110T2_CORE049<QR", "CS110T2_CORE050>ST",
  "CS110T2_BONUS051 +1", "CS110T2_BONUS052 -2", "CS110T2_BONUS053 =3", "CS110T2_BONUS054 _4",
  "CS110T2_BONUS055 :5", "CS110T2_BONUS056 ;6", "CS110T2_EXTRA057 [7", "CS110T2_EXTRA058 ]8",
  "CS110T2_TEST059 {9", "CS110T2_TEST060 }0", "CS110T3_MAIN001#A@", "CS110T3_MAIN002!Z*",
  "CS110T3_MAIN003$K#", "CS110T3_MAIN004&Y!", "CS110T3_MAIN006^R&", "CS110T3_MAIN007~S+",
  "CS110T3_MAIN008?D#", "CS110T3_MAIN009|Q$", "CS110T3_MAIN010<>P", "CS110T3_BONUS011 %1",
  "CS110T3_BONUS012 @2", "CS110T3_BONUS013 #3", "CS110T3_BONUS014 &4", "CS110T3_BONUS015 *5",
  "CS110T3_BONUS016 ^6", "CS110T3_EXTRA017 ~7", "CS110T3_EXTRA018 ?8", "CS110T3_TEST019 |9",
  "CS110T3_TEST020 <0", "CS110T1_MAIN001#A@", "CS110T1_MAIN002!Z*", "CS110T1_MAIN003$K#",
  "CS110T1_MAIN004&Y!", "CS110T1_MAIN005*X%", "CS110T1_MAIN006^R&", "CS110T1_MAIN007~S+",
  "CS110T1_MAIN008?D#", "CS110T1_MAIN009|Q$", "CS110T1_MAIN010<>P", "CS110T1_BONUS011 %1",
  "CS110T1_BONUS012 @2", "CS110T1_BONUS013 #3", "CS110T1_BONUS014 &4", "CS110T1_BONUS015 *5",
  "CS110T1_BONUS016 ^6", "CS110T1_EXTRA017 ~7", "CS110T1_EXTRA018 ?8", "CS110T1_TEST019 |9",
  "CS110T1_TEST020 <0", "Lizzy@", "CS110T3_MAIN005*X%", "REAL🌟JED", "BI110_TOTAL_ACCESS",
  "FULL_UNLOCK_2025", "ACCESS_GRANTED_GLOBAL$", "BI110_BUNDLE_PACK_123", "SUPER_USER_XYZ_789",
  "CBU_UNLOCK_CODE🔥", "MASTER_KEY_∞_ENTRY", "kk22kk4", "BI110_PRO_MODE", "CS110_PRO_PASS_ABC",
  "BI110T2_MAIN003$K#", "ElijA⚓H", "All-terms@#<00", "CS110_PRO_PLUS_TERMS", "BI110_TEST_PASS_XYZ",
  "Lizzy", "CS110_ALL_YEARS_PASS", "ULTRA_PASS_9999", "BI110T2_MAIN005*X%", "GLOBAL_MASTER_777🔐",
  "CS110T2_MAIN002!Z*", "BI110T2_MAIN003$K#", "BI&CS110T2@", "BI110_T1_T2_T3_OKAY",
  "CS110_TERM_UNLOCKER_1", "BI110_GRADEBOOST_2025", "UNIVERSAL_ACCESS_VIP", "CBU_ELITE_KEY2025",
  "EVERYTHING_PASS_T1T2T3", "BI110_FLASHCARDS_OPENALL", "BI110_ALL_TERM_ENTRY", "CS110_T1_T2_T3_UNLOCK",
  "TOTAL_DOMINATOR_CODE", "CS110_TOP_SECRET_PASS"
];

// =================================================================
// === SPA INITIALIZER: Call this function to start a specific term ===
// =================================================================
function initializeQuizApp(courseId, termId) {
  // 1. Reset UI & State
  ...
  // 2. Initialize TTS Preference & Button
...
updateTtsButtonText();
  ...
  // 4. Load Data from Global Scope (Assumes data files are loaded)
  ...
  allDocuments = typeof documents !== 'undefined' ? documents : []; // if you have documents.js

  // 5. Filter Data for Current Selection
  ...
  // Priority Checks
  if (checkAndApplyAccess(localStorage.getItem("accessCode_" + currentTermKey), localStorage.getItem("accessCodeExpires_" + currentTermKey), "Term Access")) {
    foundValidAccess = true; needsPrompt = false;
  }
  if (!foundValidAccess && currentCourse) {
    if (checkAndApplyAccess(localStorage.getItem("accessCode_" + courseAllTermsKey), localStorage.getItem("accessCodeExpires_" + courseAllTermsKey), "Course-wide Access")) {
      foundValidAccess = true; needsPrompt = false;
    }
  }
  if (!foundValidAccess) {
    if (checkAndApplyAccess(localStorage.getItem("accessCode_GLOBAL_ALL_TERMS"), localStorage.getItem("accessCodeExpires_GLOBAL_ALL_TERMS"), "Global Access")) {
      foundValidAccess = true; needsPrompt = false;
    }
  }
  ...
  if (needsPrompt) {
    ...
    if (!userCode) {
      ...
      denyAccess(`❌ "${userCode}" has already been activated.`, userCode);
    } else {
      ...
      if (fullAccessCodes.GLOBAL_ALL_TERMS && fullAccessCodes.GLOBAL_ALL_TERMS.includes(userCode)) {
        codeFoundInConfig = true; accessType = "Global Access"; storageKeyPrefix = "GLOBAL_ALL_TERMS";
      } else if (fullAccessCodes[courseAllTermsKey] && fullAccessCodes[courseAllTermsKey].includes(userCode)) {
        codeFoundInConfig = true; accessType = "Course-wide Access"; storageKeyPrefix = courseAllTermsKey;
      } else if (fullAccessCodes[currentTermKey] && fullAccessCodes[currentTermKey].includes(userCode)) {
        codeFoundInConfig = true; accessType = "Term Access"; storageKeyPrefix = currentTermKey;
      }
...
Short answer question is not being read check
...
let html = <div class="question-header"> <h3>MCQ ${currentQuestionIndex + 1} / ${currentQuizData.length}</h3> </div> <div class="question-box"> <p>${q.q}</p> <div class="options">;
...
resultDiv.innerHTML = "";
if (!selected) { showAppNotification("Select an option!", "warning"); return; }

const q = currentQuizData[currentQuestionIndex];
const userAnswer = parseInt(selected.value);
let feedbackText = "";
if (userAnswer === q.correct) {
currentScore++; resultDiv.innerHTML = "<p>✔️ Correct!</p>"; feedbackText = "Correct!";
} else {
...
container.innerHTML = <h3>Short Answer ${currentQuestionIndex + 1} / ${currentQuizData.length}</h3> <div class="question-box"> <p>${q.q}</p> </div> <textarea id="short-answer-input"></textarea> <button onclick="checkShortAnswer()">✅ Submit</button>;
...
resultDiv.innerHTML = "";
let feedbackText = "";
if (!ans) { showAppNotification("Please type your answer!", "warning"); return; }
...
if (!step) { showFinalEssayScore(); return; }
let html = <div class="question-header"><h3>📄 ${essay.title} — Step ${index + 1} of ${essay.steps.length}</h3><p>Topic: ${essay.topic} | ${essay.year} | ${essay.tag || ""}</p></div><div class="question-box"><p><strong>Q:</strong> ${step.q}</p><div class="options">;
step.options.forEach((opt, i) => {
html += <label class="option"><input type="radio" name="step-option" value="${i}" /><span>${String.fromCharCode(65 + i)}. ${opt}</span></label>;
});
html += </div><button onclick="checkEssayStep()">✅ Submit Step</button></div>;
container.innerHTML = html;
document.getElementById("result").innerHTML = "";
container.scrollIntoView({ behavior: "smooth" });
readCurrentQuestion();
...
resultDiv.innerHTML = "";
let feedbackText = "";
if (!selectedOption) { showAppNotification("Please select an option!", "warning"); return; }
...
if (correct) {
essayScore++; resultDiv.innerHTML = "<p>✔️ Correct!</p>"; feedbackText = "Correct!";
} else {
...
const nextBtn = document.createElement("button");
nextBtn.innerText = currentStepIndex < currentEssay.steps.length - 1 ? "Next ➡️" : "Finish";
nextBtn.onclick = () => { if (currentStepIndex < currentEssay.steps.length - 1) { currentStepIndex++; showEssayStep(currentStepIndex); } else { showFinalEssayScore(); } };
resultDiv.appendChild(nextBtn);
...
updateProgress(0, 0);
if (Object.keys(currentFlashcardTopics).length === 0) { container.innerHTML = "<p>No flashcards available for this term.</p>"; return; }
...
container.innerHTML = <h3>Flashcard: ${currentFlashcardTopic} (${currentCardIndex + 1} / ${currentFlashcards.length})</h3><div class="flashcard-wrapper"><div class="flashcard ${isCardFront ? '' : 'back-active'}" onclick="flipCard()"><div class="card-face card-front">${card.front}</div><div class="card-face card-back">${card.back}</div></div></div><div class="flashcard-nav-buttons"><button onclick="prevFlashcard()" ${currentCardIndex === 0 ? 'disabled' : ''}>⬅️ Prev</button><button onclick="nextFlashcard()" ${currentCardIndex === currentFlashcards.length - 1 ? 'disabled' : ''}>Next ➡️</button></div><button class="back-to-topics-button" onclick="renderFlashcardTopics()">⬅️ Back to Topics</button>;
container.scrollIntoView({ behavior: "smooth" });
readFlashcard();
}
...
function nextFlashcard() { if (currentCardIndex < currentFlashcards.length - 1) { currentCardIndex++; isCardFront = true; displayFlashcard(); } else { showFlashcardCompletion(); } }
function showFlashcardCompletion() {
const container = document.getElementById("quiz-form");
container.innerHTML = <p>✅ Done with flashcards for "${currentFlashcardTopic}".</p><button onclick="startFlashcards(currentFlashcardTopic)">🔁 Review Again</button><button onclick="renderFlashcardTopics()">⬅️ Back to Topics</button>;
...
const resultDiv = document.getElementById("result");
resultDiv.innerHTML = "";
if (!hasFullAccess) { quizForm.innerHTML = <div class="feedback"><p><strong>🚫 Documents are locked.</strong><br>Please purchase access to unlock PDF downloads.</p></div>; return; }

// Assumes allDocuments is populated
const filtered = allDocuments.filter(doc => doc.course === currentCourse && doc.term === currentTerm);
if (filtered.length === 0) { quizForm.innerHTML = <div class="feedback"><p>No documents found for ${currentCourse} ${currentTerm}.</p></div>; return; }

let html = <div class="feedback"><h3>📄 Available Documents</h3><ul>;
filtered.forEach(doc => { html += <li><a href="${doc.filePath}" target="_blank">${doc.title}</a></li>; });
html += </ul></div>;
...
switch (e.key) {
case "ArrowDown": case "ArrowRight": if (options.length) { index = (index + 1) % options.length; options[index].checked = true; } break;
case "ArrowUp": case "ArrowLeft": if (options.length) { index = (index - 1 + options.length) % options.length; options[index].checked = true; } break;
case "1": if(options[0]) options[0].checked=true; break;
case "2": if(options[1]) options[1].checked=true; break;
case "3": if(options[2]) options[2].checked=true; break;
case "4": if(options[3]) options[3].checked=true; break;
case "Enter": if (currentQuizType === "mcq") checkMcqAnswer(); if (currentQuizType === "essay") checkEssayStep(); break;
case " ": const nextBtn = document.querySelector("#result button"); if (nextBtn) nextBtn.click(); break;
}
}
if (currentQuizType === "shortAnswer" && e.key === "Enter") {
if (!e.shiftKey) { e.preventDefault(); checkShortAnswer(); }
}
...
function updateTtsButtonText() { const ttsButton = document.getElementById('tts-toggle-button'); if (ttsButton) { ttsButton.textContent = ttsEnabled ? '🔊 Turn Reader Off' : '🔇 Turn Reader On'; } }
...
function readFlashcard() { if (!ttsEnabled) return; stopReading(); const card = currentFlashcards[currentCardIndex]; if (isCardFront) { readText(Front of card. ${card.front}); } else { readText(Back of card. ${card.back}); } }
    "BI110T1_MAIN005*X%", "BI110T1_MAIN006^R&", "BI110T1_MAIN007~S+", "BI110T1_MAIN008?D#",
    "BI110T1_MAIN009|Q$", "BI110T1_MAIN010<>P", "BI110T1_BONUS011 %1", "BI110T1_BONUS012 @2",
    "BI110T1_BONUS013 #3", "BI110T1_BONUS014 &4", "BI110T1_BONUS015 *5", "BI110T1_BONUS016 ^6",
    "BI110T1_EXTRA017 ~7", "BI110T1_EXTRA018 ?8", "BI110T1_TEST019 |9", "BI110T1_TEST020 <0"
...
function displayMcqQuestion() {
  ...
  // Added Delay to ensure TTS reads correctly
...
// UPDATED: Robust reading for all modes
function readCurrentQuestion() {
  if (!ttsEnabled) return;
  stopReading();
  let textToRead = "";

  // 1. Get the text container
  // Tries to find .question-box p (MCQ/Essay/Short) or fallback to main p
  const questionElement = document.querySelector('.question-box p') || document.querySelector('#quiz-form > p');
  
  if (questionElement) {
    let rawText = questionElement.textContent.trim();
    
    // 2. Smart logic based on Type
    if (currentQuizType === 'essay') {
         // Essays often have "Q: ...". Replace with "Question."
         textToRead = rawText.replace(/^Q[:.]?\s*/i, "Question. ");
    } else if (currentQuizType === 'shortAnswer') {
         // Add "Question." to short answer so it feels natural
         textToRead = "Question. " + rawText;
    } else {
  ...
  if (currentQuizType === 'mcq' || currentQuizType === 'essay') {
    ...
    if (optionsElements.length > 0) {
      textToRead += ". Options are: ";
      optionsElements.forEach((label, i) => {
        // Remove "A." or "B." visual markers for smoother reading
        const optionText = label.textContent.replace(/^[A-Z]\.\s*/, "").trim();
        textToRead += `${String.fromCharCode(65 + i)}. ${optionText}. `;
      });
    }
