// ============================================================
// === KAERI EDTECH QUIZ ENGINE - INTELLIGENT MASTER (v12.0) ===
// === Perfect Fusion: v10.4 Stability + v11.0 SRS + Fixed Algorithm ===
// === 100% Intelligent Learning System with Zero Compromise ===
// ============================================================
...
function parseKaeriMarkdown(text) {
    ...
    // Headers with intelligent styling
    ...
    // Text formatting with proper nesting support
...
// ============================================================
// === 1. INTELLIGENT INITIALIZATION & DATA LOADING ===
// ============================================================

function loadGlobalData() {
    // Intelligent data detection with fallbacks
...
async function initializeCourseLogic() {
    ...
    if (modeButtonsDiv) {
        // Intelligent UI injection - only if missing
...
// ============================================================
// === 2. INTELLIGENT RENDERING ENGINE (KaTeX) ===
// ============================================================

function renderMath(targetId = null) {
    // Intelligent rendering - only process if library exists
...
// ============================================================
// === 3. INTELLIGENT DOCUMENT DELIVERY ENGINE ===
// ============================================================
...
function logDocumentView(title, fileId) {
    // Intelligent logging - don't break if server unreachable
    try {
...
// ============================================================
// === 4. INTELLIGENT SECURITY & AUTHENTICATION ===
// ============================================================
...
// ============================================================
// === 7. INTELLIGENT SRS ENGINE (PERFECTED SM-2 ALGORITHM) ===
// === Fixed: Jump Start Logic - Honors User Ratings on First Try ===
// ============================================================

const SRS_KEY_PREFIX = "kaeri_srs_v2_"; // Version bump for algorithm improvement
...
// ============================================================
// === THE PERFECTED ALGORITHM ===
// === 100% Intelligent - Honors User Ratings + Scientific Spacing ===
// ============================================================

function calculateNextReview(topic, cardIndex, quality) {
    let card = getCardSRS(topic, cardIndex);
    
    // Handle forgotten cards (quality < 3)
    if (quality < 3) {
        card.repetition = 0;
        card.interval = 1; // Review tomorrow
    } 
    // Handle successful recalls (quality 3, 4, or 5)
    else {
        // FIRST TIME SEEING THIS CARD - JUMP START LOGIC
        // Trust the user's confidence rating completely
        if (card.repetition === 0) {
            switch(quality) {
                case 3: // Hard - moderate confidence
                    card.interval = 2; // 2 days
                    break;
                case 4: // Good - high confidence
                    card.interval = 4; // 4 days
                    break;
                case 5: // Easy - very high confidence
                    card.interval = 7; // 7 days
                    break;
                default:
                    card.interval = 1; // Fallback (should never happen)
            }
        } 
        // SECOND SUCCESSFUL RECALL
        else if (card.repetition === 1) {
            // Intelligent second interval calculation
            // If the first interval was substantial (6+ days), apply multiplier
            // Otherwise use standard 6 days to avoid over-multiplying small intervals
            card.interval = (card.interval >= 6) 
                ? Math.round(card.interval * card.efactor) 
                : 6;
        } 
        // THIRD AND SUBSEQUENT SUCCESSFUL RECALLS
        else {
            // Standard SM-2 multiplier for mature cards
    ...
    // Update Easiness Factor (SM-2 formula with slight forgiveness)
...
// ============================================================
// === 8. INTELLIGENT FLASHCARD ENGINE WITH SMART LAYOUT ===
// ============================================================
...
// Intelligent layout detection function
...
function displayFlashcard() {
    ...
    // Apply intelligent layout based on content
    ...
    let html = `
        ...
        <div class="flashcard-wrapper">
            <div class="flashcard ${isCardFront ? '' : 'back-active'}" onclick="flipCard()">
                ...
                <!-- FRONT FACE with intelligent layout -->
                ...
                <!-- BACK FACE with intelligent layout -->
    ...
    // Intelligent button rendering based on card state
    ...
    if (isCardFront) {
        ...
        // Buttons now match the algorithm perfectly - intervals are accurate
        html += `
...
function rateCard(quality) {
    ...
    // Notification now matches exactly what the button promised
...
function showFlashcardCompletion() {
    ...
    container.innerHTML = `
        <div style="text-align: center;">
            ...
            <p>Your spaced repetition data has been saved. Cards will return when you need to review them.</p>
        </div>
    `;
...
// ============================================================
// === 11. INTELLIGENT TEXT-TO-SPEECH ENGINE ===
// ============================================================
...
const ttsMap = [
    ...
    // Cleanup markdown and LaTeX artifacts
...
// ============================================================
// === 12. INTELLIGENT EVENT HANDLERS & STUDENT BOARD ===
// ============================================================
...
document.addEventListener("keydown", (e) => {
    ...
    // Flashcard controls with SRS rating shortcuts
