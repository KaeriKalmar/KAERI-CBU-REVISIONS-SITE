...
const fullAccessCodes = {
    "BI110_T1": ['YOUR_BI110T1_CODE_A',"charity","test",'ANOTHER_BI110T1_CODE',"kkkkk"],
    "BI110_T2": ["YOUR_BI110T2_CODE_X"],
   
    "BI110_T3": ["YOUR_BI110T3_CODE_Y"],
  
    "CS110_T1": ["YOUR_CS110T1_CODE_A","test2"],
   
    "CS110_T2": ["YOUR_CS110T2_CODE_B","test3"],
    "CS110_T3": ["YOUR_CS110T3_CODE_C"]
};
const revokedAccessCodes = ['charity', 'BI110T2_CODE_B_REVOKED',"YOUR_BI110T1_CODE_A"];

let usedAccessCodes = ["BI110_T2","YOUR_BI110T1_CODE_A","kkkkk"];
